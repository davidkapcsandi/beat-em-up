...
namespace CodeRedCat.ResponsiveScroller.Sample.Scripts
{
    ...
    public class CameraScroll : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            Vector3 scrollSpeed = new Vector3(Mathf.Lerp(scrollSpeedA.x, scrollSpeedB.x, lerpValue), Mathf.Lerp(scrollSpeedA.y, scrollSpeedB.y, lerpValue), Mathf.Lerp(scrollSpeedA.z, scrollSpeedB.z, lerpValue));
            
            Vector3 newPosition = transform.position + scrollSpeed * Time.deltaTime;
